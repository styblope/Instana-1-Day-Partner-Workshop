...
## Step 4: LAMP stack monitoring

Copy these Ansible files to the VMs into the default user home directory.
- [lamp-install.yml](https://raw.githubusercontent.com/styblope/Instana-1-Day-Partner-Workshop/refs/heads/main/files/lamp-install.yml)
- [lamp-remove.yml](https://raw.githubusercontent.com/styblope/Instana-1-Day-Partner-Workshop/refs/heads/main/files/lamp-remove.yml)

Install Ansible on the machines
```sh
