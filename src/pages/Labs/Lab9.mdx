...
In Lab 9, you will create a custom event that will trigger when a component of our application is offline. 
At the end of this lab, you will be able to verify that your event has triggered and review the event. 
